...
def _make_hermes_provider_class() -> Optional[type]:
    ...
    auth_flow_locks: dict[str, asyncio.Lock] = {}
    ...
    class HermesMCPOAuthProvider(OAuthClientProvider):
        ...
        async def async_auth_flow(self, request):  # type: ignore[override]
            lock = auth_flow_locks.setdefault(self._hermes_server_name, asyncio.Lock())
            async with lock:
...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        callback_port = _configure_callback_port(cfg, server_name=server_name)
        ...
        return _HERMES_PROVIDER_CLS(
            ...
            callback_handler=lambda: _wait_for_callback_on_port(callback_port),
